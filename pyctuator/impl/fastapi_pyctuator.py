...
class FastApiPyctuator(PyctuatorRouter):
    ...
    def __init__(
        ...
        def get_endpoints() -> object:
            return {"_links": dict(self.get_endpoints_links())}
        ...
        if "metrics" in enabled_endpoints:
        ...
        if "loggers" in enabled_endpoints:
        ...
        if "httptrace" in enabled_endpoints:
